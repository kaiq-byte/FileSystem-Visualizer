...
Parts of this project, including the **animation, code, and visual concepts**, were created or assisted by **Artificial Intelligence (AI)**.

AI was used as a tool to help create a **didactic visualization** of technical concepts.

The project is intended primarily as a learning resource and should not be treated as an authoritative technical reference.
